...
uploader = st.sidebar.file_uploader("Upload an image", type=["jpg", "jpeg", "png"])

# Add a button to the sidebar to trigger the prediction
...
# Add a callback to the button to trigger the prediction
